...
import math
import numpy as np
from old.utils import score, detect_down, detect_up, in_hoop_region, clean_hoop_pos, clean_ball_pos, get_device
...
class ShotDetector:
    ...
    def run(self):
        while True:
            ...
            if cv2.waitKey(1)== ord('q'):  # higher waitKey slows video down, use 1 for webcam
                break
